...
set number relativenumber       " Use relative line number except for current line
...
" Something to do with escape delays
set ttimeout
set ttimeoutlen=50
set timeoutlen=1000

" Set relative line numbers only for the buffer in focus, use absolute line
" numbers otherwise.
...
" Use colorscheme that base16-shell sets
